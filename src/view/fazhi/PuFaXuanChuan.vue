<template>
  <div class="container">
    ...
    <d-player style="height:100%;width:97%" ref="player5" id="player5" :options="options"></d-player>
  </div>
</template>
...
export default {
  data() {
    return {
      video: [
        {
          url: "https://cuihua-dev-test.oss-cn-shanghai.aliyuncs.com/cb672a660e9c4c08a653ce3585018604.mp4",
          pic: "https://cuihua-dev-test.oss-cn-shanghai.aliyuncs.com/c77e5c6c8032447ba2ef61d1e444f932.jpg",
        },
        {
          url: "https://cuihua-dev-test.oss-cn-shanghai.aliyuncs.com/pufa1.mp4",
          pic: "https://cuihua-dev-test.oss-cn-shanghai.aliyuncs.com/pufa1.jpg",
        },
      ],
      options: {
  ...
  methods: {
    onChange(oldvalue, newvalue) {
      var toption = this.options;
      toption.video = this.video[newvalue];
      this.options = toption;
    }
  },
  mounted() {
